...
## HTML :
```
<p id="P1">Paragraphe1 id</p>
<p class="p2">Paragraphe2 class</p>
<p class="dog-name roger">Roger Tag Name</p>
...
{% include important.html content="Le style prioritaire est celui le plus proche de l'élément." %}
...
Peut contenir d'autres éléments de type "Block" et "inline".
...
- forcer propriété à hériter : "inherit"
- forcer propriété à ne pas hériter : entrer une valeur différente
